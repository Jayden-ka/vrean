        ...
        <div class="row d-flex justify-content-center my-3">
            <div class="col-sm-12 col-md-10 col-lg-7 d-flex justify-content-center">
                <div class="card w-100 bg-primary rounded text-white" style="height: 250px;">
                    ...
                    <div class="row w-100 pb-3 justify-content-end">
                        <a href="/create_material" class="btn btn-light">Meterial</a>
                    </div>
                    <div class="row w-100 pb-3 justify-content-end">
                        <a href="/create_assignment" class="btn btn-light">Assignment</a>
                    </div>
                </div>
            </div>
        </div>
