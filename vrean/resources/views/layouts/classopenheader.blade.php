...
@section('content')
    <div class="container-fluid d-flex justify-content-center">
        <div class="row d-flex justify-content-center bg-light position-sticky top-0">
            <nav class="navbar navbar-expand-lg nav_link">
    ...
    <div id="myModaljoinclass" class="modaljoinclass">                                    
        <div class="modal-contentjoinclass">
            ...
            <form class="form-group" action="" method="POST">
                ...
                {!! Form::text('caption', '', ['class'=>'form-control mb-2 w-100','placeholder'=>'Class Code']) !!}
